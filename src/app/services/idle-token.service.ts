...
import { IdleAndTokenWarningModalComponent } from '../shared/idle-token-timeout/idle-token-warning-modal/idle-token-warning-modal.component';
import { TimeoutTypeEnum } from '../shared/idle-token-timeout/idle-token-timeout.enum';
